class Camera {
    ...
    getRay(u, v) {
        const horizontalComponent = Vec3.multiply(this.#horizontal, u);
        const verticalComponent = Vec3.multiply(this.#vertical, v);
        return new Ray(this.#origin, Vec3.subtract(Vec3.add(Vec3.add( this.#lowerLeftCorner, horizontalComponent), verticalComponent), this.#origin))
    }
}
